...
class ScannerFindingsTestCase(unittest.TestCase):
    ...
    def test_same_finding_across_two_vhosts_keeps_both_hosts_and_best_severity(self) -> None:
        ...
        self.assertIn("zap.one | nth-check 1.0.2 -> fixed in >= 2.0.1 | GHSA-rp65-9cf3-cjxr", digest.body)
        self.assertIn("admin.zap.one | nth-check 1.0.2 -> fixed in >= 2.0.1 | GHSA-rp65-9cf3-cjxr", digest.body)
